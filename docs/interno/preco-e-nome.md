...
Nada disto está implementado — não existe sistema de subscrição,
pagamento, nem distinção de planos gratuito/premium no código atual.
Fica registado aqui para quando entrar em desenvolvimento.
